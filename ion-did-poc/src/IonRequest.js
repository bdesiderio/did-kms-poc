...
class IonRequest {
    ...
    static createCreateRequest(input) {
        ...
        const delta = {
            updateCommitment: updateKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode)),
            patches
        };
        ...
        const suffixData = {
            deltaHash,
            recoveryCommitment: recoveryKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode))
        };
    ...
    static createRecoverRequest(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nextUpdateCommitmentHash = 
                input.nextUpdatePublicKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode))
            ...
            const deltaHash = Multihash_1.default.canonicalizeThenHashThenEncode(delta, hashAlgorithmInMultihashCode);
            const nextRecoveryCommitmentHash = input.nextRecoveryPublicKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode))
    ...
    static createUpdateRequest(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nextUpdateCommitmentHash = input.nextUpdatePublicKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode));
            // updateKey.map(x => Multihash_1.default.canonicalizeThenDoubleHashThenEncode(x, hashAlgorithmInMultihashCode))
            ;
            const delta = {
                patches,
                updateCommitment: nextUpdateCommitmentHash
